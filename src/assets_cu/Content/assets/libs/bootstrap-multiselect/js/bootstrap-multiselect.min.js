! function (t) {
    ...
    "undefined" != typeof ko && ko.bindingHandlers && !ko.bindingHandlers.multiselect && (ko.bindingHandlers.multiselect = {
        ...
        defaults: {
            ...
            enableHTML: !1,
            buttonClass: "btn-multiselect form-control text-start",
            inheritClass: !1,
            buttonWidth: "auto",
            ...
            delimiterText: ", ",
            templates: {
                button: '<button type="button" class="multiselect dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false"><span class="multiselect-selected-text"></span><i class="mdi mdi-chevron-down float-end"></i></button>',
                ul: '<ul class="multiselect-container dropdown-menu multiselect-dropdown"></ul>',
